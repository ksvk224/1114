$(document).ready(function() {
    ...
    $(document).ready(function() {
            ...
            illust: [
                {
                    ...
                    desc: '일러스트 작업 설명입니다. 작업 의도와 컨셉을 설명합니다.'
                },
                {
                    src: './images/일러스트-낮과밤.jpg',
                    desc: '초록색 계열의 일러스트 작업입니다. 자연과 생명을 표현했습니다.'
                },
                {
        ...
        function showImage(category, index) {
            ...
            // 즉시 이미지 변경
            $modalImage.attr('src', imageData[category][index].src);
            $modalDesc.text(imageData[category][index].desc);
